(module    
  ...
  (func $setup (export "setup")
    (global.set $min_possible_buffer_reserve
      (call $max (call $line_sep_len) (call $col_sep_len))))
  ...
  (func $read (export "read") (result i32)
    (block $_block
      ...
      (if (i32.eq (global.get $state) (global.get $state_cell_and_newline))
        (block
          (global.set $input_read_idx (i32.add (global.get $input_read_idx) (call $line_sep_len)))
      ...
      (if (i32.eq (global.get $state) (global.get $state_cell))
        (block
          (global.set $input_read_idx (i32.add (global.get $input_read_idx) (call $col_sep_len)))
          (global.set $cell_write_idx (i32.const 0))
          (global.set $state (i32.const 0))))
      ...
      (loop $_loop
        ...
        (if
          (i32.and
            ...
            (i32.le_s (call $input_unprocessed) (global.get $min_possible_buffer_reserve)))
          (block
        ...
        (if
          (i32.and
            ...
            (i32.le_s (call $input_unprocessed) (i32.const 0)))
          (block
        ...
        (if
          (i32.gt_s (call $input_unprocessed) (i32.const 0))
          (block
            (i32.store8
